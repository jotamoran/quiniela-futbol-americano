  ...
  <main>
    ...
    <section class="page-shell max-w-6xl">
      <div class="grid gap-4 md:grid-cols-3">
        ...
        <article class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm"><span class="grid h-10 w-10 place-items-center rounded-full bg-red-50 font-bold text-quiniela-rojo">+2</span><h2 class="mt-4 text-lg font-bold text-quiniela-azulOscuro">Elige tu underdog</h2><p class="mt-1 text-sm leading-relaxed text-gray-600">Elige un partido y recibe dos puntos extra si aciertas al equipo no favorito.</p></article>
        <article class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm"><span class="grid h-10 w-10 place-items-center rounded-full bg-amber-50 font-bold text-amber-700">≈</span><h2 class="mt-4 text-lg font-bold text-quiniela-azulOscuro">Desempate por cercanía</h2><p class="mt-1 text-sm leading-relaxed text-gray-600">Indica el total de puntos del partido de desempate; gana quien acierte o quede más cerca.</p></article>
      </div>
