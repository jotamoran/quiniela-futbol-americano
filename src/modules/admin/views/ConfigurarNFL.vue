...
const erroresSemana = computed(() => {
  ...
  if (juegos.value.some((juego) => juego.fecha_partido && !Number.isNaN(cierre.getTime()) && new Date(juego.fecha_partido) < cierre)) errores.push('El cierre debe ser anterior o igual al primer partido.');
