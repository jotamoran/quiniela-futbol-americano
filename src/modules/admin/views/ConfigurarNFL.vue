...
function nuevoJuego() { return { equipo_visitante: '', equipo_local: '', fecha_partido: '', desempate: false }; }
...
<template>
  <main class="page-shell max-w-5xl">
    ...
    <form v-if="temporada" @submit.prevent="publicarSemana" class="space-y-4 rounded-2xl bg-white p-5 shadow-sm">
      <h2 class="font-bold text-quiniela-azulOscuro">Nueva semana</h2>
